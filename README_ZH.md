# 🎄 Christmas Magic - 圣诞魔法 / ⭐ 星空星座

[English](README.md) | **中文**

一个基于 Three.js 和 MediaPipe 的 3D 粒子特效项目，支持手势交互控制。包含两种效果模式：**圣诞树**和**星空星座**，可实时切换。
...
### ⭐ 星空星座模式
- 🌌 **7大星座** - 猎户座、大熊座、天蝎座、天鹅座、狮子座、仙女座、双子座
- ✨ **星座连线** - 星座间的连线随选中状态变化
- 🌠 **流星效果** - 随机出现的流星划过夜空
- 🌈 **星云背景** - 紫色、蓝色的星云粒子点缀背景
- 📍 **星座信息** - 悬停或点击显示星座中英文名称
...
| 手势 | 圣诞树模式 | 星空模式 |
|------|-----------|----------|
| ✋ **张开手掌** | 旋转圣诞树 + 远近缩放 | 旋转星空 + 远近缩放 |
| ☝️ **食指指向** | 选择照片（悬停 0.5 秒放大）| 高亮星座 |
| 🤏 **捏合** | 缩放视图（带惯性）| 缩放视图（带惯性）|
| ✊ **握拳** | 粒子变成球形 | 聚合分散的星星 |
| ✌️ **V字手势** | 爆炸/聚合粒子 | 分散/聚合星星 |
| 🖱️ **鼠标点击** | 点击照片放大 | 选择/取消星座 |
...
├── style.css        # 样式文件
├── main.js          # 主入口文件，效果切换逻辑
├── script.js        # 圣诞树效果逻辑
├── starry-night.js  # 星空星座效果逻辑
├── README.md        # 英文文档
└── README_ZH.md     # 中文文档
```
